...
const SignUp_login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br bg-gray-200 pt-6">
      <div className="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full bg-cyan-500 text-white py-2 rounded-lg font-semibold hover:bg-cyan-500 transition"
          >
            {isLogin ? "Login" : "Sign Up"}
          </button>
        </form>
        ...
        <p className="text-center mt-6 text-gray-600">
          ...
          <button
            onClick={toggleForm}
            className="text-blue-900 font-semibold ml-2 hover:underline"
          >
